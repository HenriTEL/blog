...
It's an alternative to abstract classes that rely on duck typing instead of inheritance.  
...
It also mean that there's no risk of partial code execution in parent classes with something like `super().mymethod()`
